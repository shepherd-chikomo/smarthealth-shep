...
import { FacilityProfileTabs } from '@/components/facility-profile-tabs';
    ...
    <div>
      ...
      {f && facilityId && (
        <FacilityProfileTabs
          ...
          savingGeneral={save.isPending}
          generalSaved={save.isSuccess}
            ...
            <>
              <div>
                ...
                <p className="mt-1 text-sm text-[var(--muted)]">
                  Drag the pin or click the map to set where patients find you.
                </p>
