...
mixin _$ProviderModel {
 ...
 String get id; String get name; String get categoryId; String? get specialty; String? get specialtyId; String? get facilityName; String? get address; String? get phone; double? get latitude; double? get longitude; double? get distanceKm; String? get hours; String? get imageUrl; String? get heroImageUrl; bool get isVerified; String? get mdpczNumber; String? get about; List<String> get services; List<WorkingHoursEntry> get weeklyHours; List<String> get conditions; List<String> get ageGroups;
...
@useResult
$Res call({
 String id, String name, String categoryId, String? specialty, String? specialtyId, String? facilityName, String? address, String? phone, double? latitude, double? longitude, double? distanceKm, String? hours, String? imageUrl, String? heroImageUrl, bool isVerified, String? mdpczNumber, String? about, List<String> services, List<WorkingHoursEntry> weeklyHours, List<String> conditions, List<String> ageGroups
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String categoryId,  String? specialty,  String? specialtyId,  String? facilityName,  String? address,  String? phone,  double? latitude,  double? longitude,  double? distanceKm,  String? hours,  String? imageUrl,  String? heroImageUrl,  bool isVerified,  String? mdpczNumber,  String? about,  List<String> services,  List<WorkingHoursEntry> weeklyHours,  List<String> conditions,  List<String> ageGroups)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProviderModel() when $default != null:
return $default(_that.id,_that.name,_that.categoryId,_that.specialty,_that.specialtyId,_that.facilityName,_that.address,_that.phone,_that.latitude,_that.longitude,_that.distanceKm,_that.hours,_that.imageUrl,_that.heroImageUrl,_that.isVerified,_that.mdpczNumber,_that.about,_that.services,_that.weeklyHours,_that.conditions,_that.ageGroups);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String categoryId,  String? specialty,  String? specialtyId,  String? facilityName,  String? address,  String? phone,  double? latitude,  double? longitude,  double? distanceKm,  String? hours,  String? imageUrl,  String? heroImageUrl,  bool isVerified,  String? mdpczNumber,  String? about,  List<String> services,  List<WorkingHoursEntry> weeklyHours,  List<String> conditions,  List<String> ageGroups)  $default,) {final _that = this;
switch (_that) {
case _ProviderModel():
return $default(_that.id,_that.name,_that.categoryId,_that.specialty,_that.specialtyId,_that.facilityName,_that.address,_that.phone,_that.latitude,_that.longitude,_that.distanceKm,_that.hours,_that.imageUrl,_that.heroImageUrl,_that.isVerified,_that.mdpczNumber,_that.about,_that.services,_that.weeklyHours,_that.conditions,_that.ageGroups);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String categoryId,  String? specialty,  String? specialtyId,  String? facilityName,  String? address,  String? phone,  double? latitude,  double? longitude,  double? distanceKm,  String? hours,  String? imageUrl,  String? heroImageUrl,  bool isVerified,  String? mdpczNumber,  String? about,  List<String> services,  List<WorkingHoursEntry> weeklyHours,  List<String> conditions,  List<String> ageGroups)?  $default,) {final _that = this;
switch (_that) {
case _ProviderModel() when $default != null:
return $default(_that.id,_that.name,_that.categoryId,_that.specialty,_that.specialtyId,_that.facilityName,_that.address,_that.phone,_that.latitude,_that.longitude,_that.distanceKm,_that.hours,_that.imageUrl,_that.heroImageUrl,_that.isVerified,_that.mdpczNumber,_that.about,_that.services,_that.weeklyHours,_that.conditions,_that.ageGroups);case _:
  return null;
...
class _ProviderModel implements ProviderModel {
  const _ProviderModel({required this.id, required this.name, required this.categoryId, this.specialty, this.specialtyId, this.facilityName, this.address, this.phone, this.latitude, this.longitude, this.distanceKm, this.hours, this.imageUrl, this.heroImageUrl, this.isVerified = false, this.mdpczNumber, this.about, final  List<String> services = const [], final  List<WorkingHoursEntry> weeklyHours = const [], final  List<String> conditions = const [], final  List<String> ageGroups = const []}): _services = services,_weeklyHours = weeklyHours,_conditions = conditions,_ageGroups = ageGroups;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProviderModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.specialty, specialty) || other.specialty == specialty)&&(identical(other.specialtyId, specialtyId) || other.specialtyId == specialtyId)&&(identical(other.facilityName, facilityName) || other.facilityName == facilityName)&&(identical(other.address, address) || other.address == address)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.distanceKm, distanceKm) || other.distanceKm == distanceKm)&&(identical(other.hours, hours) || other.hours == hours)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.heroImageUrl, heroImageUrl) || other.heroImageUrl == heroImageUrl)&&(identical(other.isVerified, isVerified) || other.isVerified == isVerified)&&(identical(other.mdpczNumber, mdpczNumber) || other.mdpczNumber == mdpczNumber)&&(identical(other.about, about) || other.about == about)&&const DeepCollectionEquality().equals(other._services, _services)&&const DeepCollectionEquality().equals(other._weeklyHours, _weeklyHours)&&const DeepCollectionEquality().equals(other._conditions, _conditions)&&const DeepCollectionEquality().equals(other._ageGroups, _ageGroups));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,categoryId,specialty,specialtyId,facilityName,address,phone,latitude,longitude,distanceKm,hours,imageUrl,heroImageUrl,isVerified,mdpczNumber,about,const DeepCollectionEquality().hash(_services),const DeepCollectionEquality().hash(_weeklyHours),const DeepCollectionEquality().hash(_conditions),const DeepCollectionEquality().hash(_ageGroups)]);
...
/// Create a copy of ProviderModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? categoryId = null,Object? specialty = freezed,Object? specialtyId = freezed,Object? facilityName = freezed,Object? address = freezed,Object? phone = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? distanceKm = freezed,Object? hours = freezed,Object? imageUrl = freezed,Object? heroImageUrl = freezed,Object? isVerified = null,Object? mdpczNumber = freezed,Object? about = freezed,Object? services = null,Object? weeklyHours = null,Object? conditions = null,Object? ageGroups = null,}) {
