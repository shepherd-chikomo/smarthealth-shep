...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,categoryId,specialty,specialtyId,facilityName,address,phone,latitude,longitude,distanceKm,hours,imageUrl,heroImageUrl,isVerified,mdpczNumber,about,const DeepCollectionEquality().hash(services),const DeepCollectionEquality().hash(weeklyHours),const DeepCollectionEquality().hash(conditions),const DeepCollectionEquality().hash(ageGroups),isOpenNow,isClosingSoon,emergencyAvailable,acceptsWalkIns,hasQueue,queueLength,waitEstimateMinutes,nextAvailableSlot,availableToday,rating,reviewCount,verificationSource,isClaimed]);
...
class _ProviderModel implements ProviderModel {
  const _ProviderModel({required this.id, required this.name, required this.categoryId, this.specialty, this.specialtyId, this.facilityName, this.address, this.phone, this.latitude, this.longitude, this.distanceKm, this.hours, this.imageUrl, this.heroImageUrl, this.isVerified = false, this.mdpczNumber, this.about, final  List<String> services = const [], final  List<WorkingHoursEntry> weeklyHours = const [], final  List<String> conditions = const [], final  List<String> ageGroups = const [], this.isOpenNow, this.isClosingSoon, this.emergencyAvailable, this.acceptsWalkIns, this.hasQueue, this.queueLength, this.waitEstimateMinutes, this.nextAvailableSlot, this.availableToday, this.rating, this.reviewCount, this.verificationSource, this.isClaimed = false}): _services = services,_weeklyHours = weeklyHours,_conditions = conditions,_ageGroups = ageGroups;
