...
mixin _$FacilityModel {
 ...
 String get id; String get name; String get slug; String get facilityType; String? get description; String? get addressLine1; String get city; String get province; String? get phone; String? get email; String? get website; double? get latitude; double? get longitude; double? get distanceKm; bool get isVerified; String? get logoPath;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,slug,facilityType,description,addressLine1,city,province,phone,email,website,latitude,longitude,distanceKm,isVerified,logoPath);

@override
String toString() {
  return 'FacilityModel(id: $id, name: $name, slug: $slug, facilityType: $facilityType, description: $description, addressLine1: $addressLine1, city: $city, province: $province, phone: $phone, email: $email, website: $website, latitude: $latitude, longitude: $longitude, distanceKm: $distanceKm, isVerified: $isVerified, logoPath: $logoPath)';
}
...
@useResult
$Res call({
 String id, String name, String slug, String facilityType, String? description, String? addressLine1, String city, String province, String? phone, String? email, String? website, double? latitude, double? longitude, double? distanceKm, bool isVerified, String? logoPath
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String slug,  String facilityType,  String? description,  String? addressLine1,  String city,  String province,  String? phone,  String? email,  String? website,  double? latitude,  double? longitude,  double? distanceKm,  bool isVerified,  String? logoPath)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FacilityModel() when $default != null:
return $default(_that.id,_that.name,_that.slug,_that.facilityType,_that.description,_that.addressLine1,_that.city,_that.province,_that.phone,_that.email,_that.website,_that.latitude,_that.longitude,_that.distanceKm,_that.isVerified,_that.logoPath);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String slug,  String facilityType,  String? description,  String? addressLine1,  String city,  String province,  String? phone,  String? email,  String? website,  double? latitude,  double? longitude,  double? distanceKm,  bool isVerified,  String? logoPath)  $default,) {final _that = this;
switch (_that) {
case _FacilityModel():
return $default(_that.id,_that.name,_that.slug,_that.facilityType,_that.description,_that.addressLine1,_that.city,_that.province,_that.phone,_that.email,_that.website,_that.latitude,_that.longitude,_that.distanceKm,_that.isVerified,_that.logoPath);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String slug,  String facilityType,  String? description,  String? addressLine1,  String city,  String province,  String? phone,  String? email,  String? website,  double? latitude,  double? longitude,  double? distanceKm,  bool isVerified,  String? logoPath)?  $default,) {final _that = this;
switch (_that) {
case _FacilityModel() when $default != null:
return $default(_that.id,_that.name,_that.slug,_that.facilityType,_that.description,_that.addressLine1,_that.city,_that.province,_that.phone,_that.email,_that.website,_that.latitude,_that.longitude,_that.distanceKm,_that.isVerified,_that.logoPath);case _:
  return null;
...
class _FacilityModel implements FacilityModel {
  const _FacilityModel({required this.id, required this.name, required this.slug, required this.facilityType, this.description, this.addressLine1, required this.city, required this.province, this.phone, this.email, this.website, this.latitude, this.longitude, this.distanceKm, this.isVerified = false, this.logoPath});
...
/// Create a copy of FacilityModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? slug = null,Object? facilityType = null,Object? description = freezed,Object? addressLine1 = freezed,Object? city = null,Object? province = null,Object? phone = freezed,Object? email = freezed,Object? website = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? distanceKm = freezed,Object? isVerified = null,Object? logoPath = freezed,}) {
